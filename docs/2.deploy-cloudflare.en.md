...
1. Go to the GitHub project **Releases** page and download the version ZIP you want (e.g. `PicoTag_v1.0.2.zip`)
2. Extract it to your PC (e.g. `C:\PicoTag`)
3. In PowerShell, go to that folder:
